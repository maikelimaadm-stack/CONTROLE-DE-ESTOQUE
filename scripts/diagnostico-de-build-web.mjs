...
export const ASSINATURAS = [
  {
    ...
    texto: [
      ...
      "  não está lá. E não marque o job como flaky: isto tem causa nomeada, mecanismo medido e",
      "  reprodução controlada — chamar de flaky é arquivar a dívida com outro nome. Reexecutar",
      "  também não resolve: sorteia de novo, com uma chance que ninguém mediu neste ambiente.",
      "",
