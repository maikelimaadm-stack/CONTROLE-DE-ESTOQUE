/** Tipos do harness de rollout `layout-documento.mjs` (JS puro), para os testes o importarem sem supressão. */
...
export declare const ASSINATURA_ORDEM: RegExp;
export declare function ocorrenciasNaOrdem(texto: string): number;
