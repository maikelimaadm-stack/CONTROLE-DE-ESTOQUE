...
| `docs/UX-ARCHITECTURE.md` | Arquitetura de navegação (Compactação V2): fonte única `apps/web/nav.registry.mjs`, menu só com módulos, busca global, filtros em vez de abas, ações contextuais, antes → depois por módulo, rotas antigas/redirecionamentos, permissões |
