...
Resumo: 417/455 (91.6%) telas implementadas ou melhoradas. TESTADO: 116 · IMPLEMENTADO: 280 · MELHORADO: 21 · EM IMPLEMENTAÇÃO: 7 · MAPEADO: 6 · BLOQUEADO: 0 · NÃO INICIADO: 25 · NÃO APLICÁVEL: 0

| ID | Módulo | Tela (referência) | Rota referência | Tipo | Nossa rota | Status | Observação |
|---|---|---|---|---|---|---|---|
...
| SCR-002 | Dashboards | Indicadores Financeiros | `/admin/financial-dashboard` | Dashboard | `/dashboards/financeiro` | IMPLEMENTADO |  |
| SCR-003 | Dashboards | Indicadores Pecuária de Corte | `/admin/livestock-dashboard` | Dashboard | `/dashboards/pecuaria` | TESTADO |  |
...
| SCR-005 | Cadastros Base › Pessoas | Usuários | `/admin/users` | Listagem | `/admin/usuarios` | TESTADO | Sem limite de licença por usuário (referência bloqueava 'limite de usuários'); vínculo perfil × fazendas |
| SCR-006 | Administrativo › Estoque | Documento Fiscal | `/admin/invoices` | Listagem | `/estoque/documentos-fiscais` | TESTADO | Importação de XML NF-e, itens, estoque e títulos em transação única |
| SCR-007 | Administrativo › Estoque | DFe Recebidas | `/admin/dfe` | Listagem | `/estoque/dfe` | EM IMPLEMENTAÇÃO | Fila de DFe e manifestação registradas localmente; consulta automática à SEFAZ (certificado A1) não integrada |
| SCR-008 | Administrativo › Estoque > Fábrica | Formulação | `/admin/foods` | Listagem | `/estoque/formulacoes` | IMPLEMENTADO |  |
| SCR-009 | Financeiro | Contas a Pagar | `/admin/expenses` | Listagem | `/financeiro/contas-a-pagar` | TESTADO |  |
| SCR-010 | Financeiro | Conta a Receber | `/admin/incomes` | Listagem | `/financeiro/contas-a-receber` | TESTADO |  |
| SCR-011 | Financeiro | Movimento Caixa/Bancário | `/admin/movements` | Listagem | `/financeiro/movimentos` | TESTADO |  |
| SCR-012 | Financeiro › Conciliação | Importar OFX | `/admin/ofx-imports` | Listagem | `/financeiro/ofx` | TESTADO | Parser OFX com teste unitário; conciliação por vínculo ou criação de movimento |
| SCR-013 | Financeiro › Conciliação | Meses Conciliados | `/admin/ofx-report` | Relatório | `/financeiro/ofx/relatorio` | IMPLEMENTADO |  |
...
| SCR-016 | Dashboards | Livro Caixa Digital | `/admin/cash-book-dashboard` | Dashboard | `/dashboards/livro-caixa` | IMPLEMENTADO |  |
| SCR-017 | Dashboards | Indicadores Suprimentos | `/admin/supply-dashboard` | Dashboard | `/dashboards/suprimentos` | IMPLEMENTADO |  |
| SCR-018 | Dashboards | Indicadores de Depreciações | `/admin/depreciation-dashboard` | Dashboard | `/dashboards/depreciacoes` | IMPLEMENTADO |  |
| SCR-019 | Dashboards | Dashboard de Ativos | `/admin/assets-dashboard` | Dashboard | `/dashboards/ativos` | IMPLEMENTADO |  |
| SCR-020 | Dashboards | Análise de Usuários | `/admin/user-analysis-dashboard` | Dashboard | `/dashboards/usuarios` | IMPLEMENTADO |  |
| SCR-021 | Dashboards | Pluviômetro | `/admin/rainfall-dashboard` | Dashboard | `/dashboards/pluviometria` | IMPLEMENTADO |  |
| SCR-022 | Dashboards | Lotação de Currais | `/admin/feedlot-dashboard` | Dashboard | `/dashboards/confinamento` | IMPLEMENTADO |  |
| SCR-023 | Dashboards | Custos do Confinamento | `/admin/feedlot-cost-dashboard` | Dashboard | `/dashboards/confinamento-custos` | IMPLEMENTADO |  |
| SCR-024 | Dashboards | Desempenho de Lotes | `/admin/feedlot-performance-dashboard` | Dashboard | `/dashboards/confinamento-desempenho` | IMPLEMENTADO |  |
| SCR-025 | Dashboards | Dashboard Estoque de Nutrição | `/admin/nutrition-stock-dashboard` | Dashboard | `/dashboards/estoque-nutricao` | IMPLEMENTADO |  |
| SCR-026 | Dashboards | Dashboard Consumo vs Fornecido | `/admin/feed-consumption-dashboard` | Dashboard | `/dashboards/consumo-racao` | IMPLEMENTADO |  |
...
| SCR-033 | Cadastros Base › Estrutura > Produtos | Saldo Inicial | `/admin/openingbalances` | Listagem | `/estoque/estoque-inicial` | TESTADO |  |
...
| SCR-035 | Cadastros Base › Pessoas | Perfil Usuário | `/admin/roles` | Listagem | `/admin/perfis` | TESTADO | Árvore de permissões por recurso × ação; autorização aplicada no servidor |
...
| SCR-042 | Cadastros Base › Financeiros | Saldo Inicial | `/admin/open-movements` | Listagem | `/financeiro/saldo-inicial` | IMPLEMENTADO |  |
...
| SCR-056 | Cadastros Base › Pecuários | Animais | `/admin/animals` | Listagem | `/pecuaria/animais` | TESTADO |  |
...
| SCR-061 | Cadastros Base › Pecuários | Lote/Módulo | `/admin/batch-grazing` | Listagem | `/pecuaria/transferencias/lote-modulo-area` | MELHORADO | Lote/Módulo e Lote/Área unificados em uma transferência com histórico |
| SCR-062 | Cadastros Base › Pecuários | Lote/Área | `/admin/batch-area` | Listagem | `/pecuaria/transferencias/lote-modulo-area` | MELHORADO | Unificado com Lote/Módulo |
| SCR-063 | Cadastros Base › Bens/Ativos | Inventário | `/admin/equipments` | Listagem | `/cadastros/equipments` | TESTADO |  |
| SCR-064 | Cadastros Base › Bens/Ativos | Depreciação Mensal | `/admin/depreciations` | Listagem | `/frota/depreciacoes` | TESTADO |  |
| SCR-065 | Cadastros Base › Bens/Ativos | Previsão de Depreciação | `/admin/depreciation-forecast` | Página | `/frota/previsao-depreciacao` | TESTADO |  |
| SCR-066 | Cadastros Base › Gerais | Fiscais | `/admin/tenant-parameters` | Formulário | `/admin/parametros` | IMPLEMENTADO |  |
| SCR-067 | Administrativo › Suprimentos | SLA Status | `/admin/supply-status` | Listagem | `/suprimentos/sla` | IMPLEMENTADO |  |
| SCR-068 | Administrativo › Suprimentos | Meus Processos | `/admin/my-proccesses` | Listagem | `/suprimentos/mine` | TESTADO |  |
| SCR-069 | Administrativo › Suprimentos | Solicitação | `/admin/request-purchase` | Listagem | `/suprimentos/request` | TESTADO |  |
| SCR-070 | Administrativo › Suprimentos | Rejeitados/Cancelados | `/admin/rejected-requests` | Listagem | `/suprimentos/rejected` | IMPLEMENTADO |  |
| SCR-071 | Administrativo › Suprimentos | Cotações | `/admin/request-quotation` | Listagem | `/suprimentos/quotation` | TESTADO |  |
| SCR-072 | Administrativo › Suprimentos | Autorização | `/admin/request-authorization` | Listagem | `/suprimentos/authorization` | TESTADO |  |
| SCR-073 | Administrativo › Suprimentos | Compras | `/admin/request-buy` | Listagem | `/suprimentos/buy` | TESTADO |  |
| SCR-074 | Administrativo › Suprimentos | Recebimentos | `/admin/request-receipts` | Listagem | `/suprimentos/receipts` | TESTADO |  |
| SCR-075 | Administrativo › Estoque | Entrada/Insumos | `/admin/input-entries` | Listagem | `/estoque/entradas` | TESTADO |  |
| SCR-076 | Administrativo › Estoque | Aprovação de Notas Fiscais | `/admin/dfe-drafts` | Listagem | `/estoque/aprovacao-notas` | IMPLEMENTADO |  |
...
| SCR-078 | Administrativo › Estoque | Baixa de Estoque | `/admin/stock-writeoffs` | Listagem | `/estoque/baixas` | IMPLEMENTADO |  |
| SCR-079 | Administrativo › Estoque | Requisição do Estoque | `/admin/requisitions` | Listagem | `/estoque/requisicoes` | TESTADO |  |
| SCR-080 | Administrativo › Estoque | Devolução do Estoque | `/admin/devolution` | Listagem | `/estoque/devolucoes` | TESTADO |  |
| SCR-081 | Administrativo › Estoque | Correção de Estoque | `/admin/stock-corrections` | Listagem | `/estoque/correcoes` | IMPLEMENTADO |  |
| SCR-082 | Administrativo › Estoque | Transferência de Armazém | `/admin/warehouse-transfer` | Listagem | `/estoque/transferencias?kind=warehouse` | TESTADO |  |
| SCR-083 | Administrativo › Estoque | Transferência de Armazém entre Fazendas | `/admin/warehouse-transfer-between-farms` | Listagem | `/estoque/transferencias?kind=farm` | TESTADO |  |
| SCR-084 | Administrativo › Estoque | Saldo Estoque | `/admin/stocks` | Listagem | `/estoque/saldo` | TESTADO |  |
| SCR-085 | Administrativo › Estoque > Fábrica | Batida | `/admin/food-beats` | Listagem | `/estoque/batidas` | IMPLEMENTADO |  |
...
| SCR-090 | Administrativo › Gestão Pessoal | Adiant. Salarial | `/admin/advances` | Listagem | `/gestao-pessoal/adiantamentos` | TESTADO |  |
...
| SCR-093 | Administrativo › Gestão Pessoal | Apuração Mensal | `/admin/earnings` | Listagem | `/gestao-pessoal/apuracao` | TESTADO |  |
...
| SCR-096 | Operacional › Pecuária | Gestão Animais | `/admin/animals-management` | Listagem | `/pecuaria/animais` | TESTADO |  |
...
| SCR-099 | Operacional › Pecuária > Transferências | Evolução de Rebanho | `/admin/evolution-animals` | Listagem | `/pecuaria/transferencias/evolucao` | IMPLEMENTADO |  |
| SCR-100 | Operacional › Pecuária > Transferências | Agrupar Lotes | `/admin/grouper-batches` | Listagem | `/pecuaria/transferencias/agrupar-lotes` | IMPLEMENTADO |  |
| SCR-101 | Operacional › Pecuária > Movimentações | Venda de Animais | `/admin/movement-sales` | Listagem | `/pecuaria/movimentacoes/sale` | TESTADO |  |
| SCR-102 | Operacional › Pecuária > Movimentações | Compra de Animais | `/admin/movement-purchases` | Listagem | `/pecuaria/movimentacoes/purchase` | TESTADO |  |
| SCR-103 | Operacional › Pecuária > Movimentações | Nascimentos | `/admin/birth-animals` | Listagem | `/pecuaria/movimentacoes/birth` | IMPLEMENTADO |  |
| SCR-104 | Operacional › Pecuária > Movimentações | Mortes | `/admin/death-animals` | Listagem | `/pecuaria/movimentacoes/death` | IMPLEMENTADO |  |
| SCR-105 | Operacional › Pecuária > Movimentações | Perdas | `/admin/loss-animals` | Listagem | `/pecuaria/movimentacoes/loss` | IMPLEMENTADO |  |
| SCR-106 | Operacional › Pecuária > Manejo | Processamentos | `/admin/processing` | Listagem | `/pecuaria/processamentos` | TESTADO |  |
| SCR-107 | Operacional › Pecuária > Manejo | Pré-Lotes | `/admin/purchase-lots` | Listagem | `/pecuaria/processamentos` | MAPEADO | Pré-lotes representados pelos lotes por contagem (herd_lots) da compra; sem tela própria |
| SCR-108 | Operacional › Pecuária > Manejo | Pesagens | `/admin/weighings` | Listagem | `/pecuaria/pesagens` | TESTADO |  |
| SCR-109 | Operacional › Pecuária > Manejo | Nutrição | `/admin/nutritions` | Listagem | `/pecuaria/manejo/nutrition` | IMPLEMENTADO |  |
| SCR-110 | Operacional › Pecuária > Manejo | Sanitários | `/admin/sanitaries` | Listagem | `/pecuaria/manejo/sanitary` | TESTADO |  |
| SCR-111 | Operacional › Pecuária > Manejo | Desmama | `/admin/weanings` | Listagem | `/pecuaria/manejo/weaning` | IMPLEMENTADO |  |
| SCR-112 | Operacional › Pecuária > Manejo | Apartações | `/admin/separations` | Listagem | `/pecuaria/manejo/separation` | IMPLEMENTADO |  |
| SCR-113 | Operacional › Pecuária > Manejo | Localizar Animal | `/admin/locate-animals` | Página | `/pecuaria/localizar` | IMPLEMENTADO |  |
| SCR-114 | Operacional › Pecuária > Manejo | Pastagem | `/admin/pastures` | Listagem | `/pecuaria/manejo/pasture` | IMPLEMENTADO |  |
...
| SCR-117 | Operacional › Pecuária > Manejo > Reprodução | Lotes/Reprodução | `/admin/breeding-batch` | Listagem | `/pecuaria/reproducao/acasalamentos` | MAPEADO | Lotes de reprodução por estação: filtro por lote no picker de matrizes; sem entidade própria |
...
| SCR-120 | Operacional › Pecuária > Manejo > Reprodução | Acasalamento | `/admin/breeding-matings` | Listagem | `/pecuaria/reproducao/acasalamentos` | IMPLEMENTADO |  |
...
| SCR-126 | Operacional › Pecuária > Confinamento > Nutrição | Batelada | `/admin/diet-beats` | Listagem | `/confinamento/bateladas` | IMPLEMENTADO |  |
| SCR-127 | Operacional › Pecuária > Confinamento > Nutrição | Trato Diário | `/admin/diet-beat-supplies` | Listagem | `/confinamento/trato` | IMPLEMENTADO |  |
| SCR-128 | Operacional › Pecuária > Confinamento > Nutrição | Leitura de Cocho | `/admin/trough-readings` | Listagem | `/confinamento/leitura-cocho` | IMPLEMENTADO |  |
| SCR-129 | Operacional › Pecuária > Confinamento | Mapa de Confinamento | `/admin/feedlot-map` | Página | `/confinamento/mapa` | IMPLEMENTADO |  |
| SCR-130 | Operacional | Pluviometria | `/admin/rainfalls` | Listagem | `/cadastros/rainfalls` | IMPLEMENTADO |  |
| SCR-131 | Operacional › Vendas | Orçamentos | `/admin/budgets` | Listagem | `/vendas/budgets` | TESTADO |  |
| SCR-132 | Operacional › Vendas | Pedidos | `/admin/orders` | Listagem | `/vendas/orders` | TESTADO |  |
| SCR-133 | Operacional › Vendas | Vendas | `/admin/sales` | Listagem | `/vendas/sales` | TESTADO |  |
| SCR-134 | Operacional › Ordens de Serviço | Minhas Ordens de Serviço | `/admin/my-service-orders` | Listagem | `/os?mine=1` | IMPLEMENTADO |  |
| SCR-135 | Operacional › Ordens de Serviço | Ordem de Serviço | `/admin/service-orders` | Listagem | `/os` | IMPLEMENTADO |  |
| SCR-136 | Operacional › Ordens de Serviço | Monitoramento de Ordens de Serviço | `/admin/monitoring-service-orders` | Listagem | `/os/monitoramento` | IMPLEMENTADO |  |
...
| SCR-138 | Financeiro | Análise do Fluxo Bancário | `/admin/cash-flow` | Relatório | `/financeiro/fluxo` | TESTADO |  |
| SCR-139 | Financeiro | Gestão Contratos | `/admin/contracts` | Listagem | `/cadastros/contracts` | IMPLEMENTADO |  |
| SCR-140 | Financeiro | Previsão Orçamentária Anual | `/admin/budget-plannings` | Listagem | `/financeiro/previsao-orcamentaria` | IMPLEMENTADO |  |
...
| SCR-143 | Gestão de Frota | Manutenções | `/admin/maintenances` | Listagem | `/frota/manutencoes` | IMPLEMENTADO |  |
| SCR-144 | Gestão de Frota | Abastecimentos | `/admin/supplies` | Listagem | `/frota/abastecimentos` | TESTADO |  |
...
| SCR-147 | Gestão de Frota | Transferência de Máquinas | `/admin/equipment-transfer` | Listagem | `/frota/transferencias` | IMPLEMENTADO |  |
...
| SCR-151 | Gestão Fiscal | LCDPR - Livro Caixa Digital do Produtor Rural | `/admin/cash-book` | Listagem | `/dashboards/livro-caixa` | EM IMPLEMENTAÇÃO | Dados do livro caixa capturados (contas 'livro caixa', dedutibilidade); geração do arquivo LCDPR não implementada |
...
| SCR-153 | Gestão Fiscal | Partida Dobrada | `/admin/double-entry-accountings` | Listagem | `/fiscal/partida-dobrada` | IMPLEMENTADO |  |
...
| SCR-262 | Integrações | Integração Domínio | `/admin/integration-dominios` | Listagem | `/integracoes/exportacoes` | NÃO INICIADO | Integração contábil Domínio não construída; exportação CSV/XLSX disponível |
| SCR-263 | Integrações | Integração CTA Smart | `/admin/integration-cta-smart` | Listagem | `/frota/abastecimentos` | NÃO INICIADO | Campo 'origem' preparado (cta_smart); importação automática não construída |
| SCR-264 | Integrações | CTA Smart - Abastecimentos Importados | `/admin/cta-smart-supplies` | Listagem | `/frota/abastecimentos` | NÃO INICIADO | Idem CTA Smart |
| SCR-265 | Integrações › Exportações/CSV | Exportar CSV - Contas Pagas/Recebidas | `/admin/financial-export` | Página | `/integracoes/exportacoes` | IMPLEMENTADO |  |
| SCR-266 | Cadastros Base › Pessoas | Funcionários | `/admin/employees/report` | Relatório | `/integracoes/exportacoes` | IMPLEMENTADO |  |
...
| SCR-301 | Cadastros Base › Estrutura > Produtos | Produtos | `/admin/products/report` | Relatório | `/integracoes/exportacoes` | IMPLEMENTADO |  |
...
| SCR-318 | Cadastros Base › Pessoas | Proprietários | `/admin/proprietaries/report` | Relatório | `/integracoes/exportacoes` | IMPLEMENTADO |  |
...
| SCR-322 | Cadastros Base › Pessoas | Fornecedores | `/admin/providers/report` | Relatório | `/integracoes/exportacoes` | IMPLEMENTADO |  |
...
| SCR-326 | Cadastros Base › Pessoas | Clientes | `/admin/clients/report` | Relatório | `/integracoes/exportacoes` | IMPLEMENTADO |  |
...
| SCR-348 | Cadastros Base › Fiscais | Plano de Contas | `/admin/plan-accounts/report` | Relatório | `/integracoes/exportacoes` | IMPLEMENTADO |  |
...
| SCR-389 | Administrativo › Gestão Pessoal | Equipes | `/admin/teams/report` | Relatório | `/integracoes/exportacoes` | IMPLEMENTADO |  |
...
| SCR-394 | Administrativo › Gestão Pessoal | Funcionário X Eventos | `/admin/employeeevents/report` | Relatório | `/integracoes/exportacoes` | IMPLEMENTADO |  |
