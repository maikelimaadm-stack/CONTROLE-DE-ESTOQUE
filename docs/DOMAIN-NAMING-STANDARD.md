...
| Empresa selecionada | Empresa selecionada | **`ctx.empresaId`, `X-Empresa-Id`** ✅ | — | PRE-BASE2-03. Desde **PRE-BASE2-05A** o cliente só envia o canônico; a API ainda aceita o cabeçalho antigo de clientes anteriores até 05B, e os dois com valores divergentes → 422. |
