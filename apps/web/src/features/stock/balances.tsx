...
export function BalancesPanel({ onAdjust }: { onAdjust?: (row: Row) => void } = {}) {
  ...
  return <Card className="flex min-h-0 flex-1 flex-col"><CardHeader title="Saldo de Estoque" actions={<><Button size="sm" variant="outline" onClick={() => download(`/api/reports/stocks_consolidated?format=xlsx`, "estoque.xlsx")}>Exportar</Button></>} /><CardBody>
