...
export function EarningsPanel() {
  const { can } = useAuth(); const empresa = useEmpresaPadrao(); const [empresaId, setFarmId] = React.useState(""); const [month, setMonth] = React.useState(monthStartISO()); const [sel, setSel] = React.useState<string | null>(null); const [gen, setGen] = React.useState(false);
  React.useEffect(() => { setFarmId((o) => o || empresa); }, [empresa]);
