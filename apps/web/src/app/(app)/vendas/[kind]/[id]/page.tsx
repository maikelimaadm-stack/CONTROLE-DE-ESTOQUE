  ...
  return <>
    <CentralVendasWorkspace
      ...
      dados={<>
        ...
        {variante === "sale" && !d["categoria_financeira_codigo"] && editavel && <p data-testid="classificacao-padrao-automatico" className="text-xs text-muted-foreground">Sem classificação: ao confirmar, a venda usará o padrão automático (primeira categoria de receita e primeiro centro de custo analíticos, pela ordem do código).</p>}
