    ...
    <div className="space-y-4">
      ...
      {d && <>
        ...
        <div className="grid gap-3 lg:grid-cols-2">
          ...
          <Card><CardHeader title="Custo de produção por centro de resultado" subtitle="Despesas (títulos) no período" /><CardBody>{d.production_cost_by_center.length ? <Donut data={d.production_cost_by_center} nameKey="cost_center" valueKey="expense" /> : <p className="text-sm text-slate-400">Sem despesas no período.</p>}</CardBody></Card>
        </div>
