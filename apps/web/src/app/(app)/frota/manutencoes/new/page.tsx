...
export default function Page() {
  ...
  const [h, setH] = React.useState({ empresa_id: "", maintenance_date: todayISO(), harvest_id: "", note: "" }); const [ms, setMs] = React.useState<Machine[]>([blank()]);
