...
export default function Page({ params }: { params: Promise<{ type: string }> }) {
  ...
  const [f, setF] = React.useState({ empresa_id: "", handling_date: todayISO(), batch_id: "", product_id: "", warehouse_id: "", dose: "", responsible: "", note: "", new_batch_id: "", new_category_id: "", mode: "animals", herd_lot_id: "", quantity: "1" }); const [sel, setSel] = React.useState<string[]>([]);
