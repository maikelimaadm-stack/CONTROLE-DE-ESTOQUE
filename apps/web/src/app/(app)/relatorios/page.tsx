...
import { Card, CardHeader, CardBody, Input, Spinner } from "@/components/ui";
...
export default function Page() {
  ...
  return <Card><CardHeader title="Relatórios" subtitle={`${q.data?.length ?? 0} relatórios disponíveis para o seu perfil · exportação CSV/XLSX e impressão`} actions={<Input placeholder="Buscar relatório…" value={s} onChange={(e) => setS(e.target.value)} className="w-64" />} /><CardBody>
    {q.isLoading && <Spinner />}
