...
export default function Page() {
  ...
  return <Card><CardHeader title="DFe Recebidas" subtitle="Documentos fiscais eletrônicos recebidos. A captura automática na SEFAZ depende de certificado digital (integração futura); XMLs podem ser importados manualmente." actions={<>{can("dfe.create") && <Button size="sm" onClick={() => setOpen(true)}>Buscar/Importar DFe</Button>}<Link href="/estoque/aprovacao-notas"><Button size="sm" variant="outline">Aprovação de Notas</Button></Link></>} /><CardBody>
