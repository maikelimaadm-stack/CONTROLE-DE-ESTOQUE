...
export default function Page({ params }: { params: Promise<{ id: string }> }) {
  ...
  return <StockDocDetail id={id} endpoint="/api/stock/requisitions" base="/estoque?tab=operacoes&sub=requisicoes" title="Requisição de estoque" perm="requisitions" entidade="requisitions" dateKey="requisition_date"
