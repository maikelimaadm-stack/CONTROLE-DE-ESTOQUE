...
export const EXCECOES_RLS_EMPRESA = {
  ...
  proprietary_empresas: { categoria: "E", protecao: filhoDe("erp.people", "person_id"), motivo: "Mesmo caso: abrangência do proprietário.", protegidaPor: "política api_child + proprietaries.view/edit na API (aba Proprietário do parceiro) + escopo de empresa na API: a linha de empresa fora do escopo do usuário não é lida, alterada nem apagada (decisão 253, item 8)" },
