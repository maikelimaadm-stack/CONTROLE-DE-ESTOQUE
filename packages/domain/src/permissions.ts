...
export const PERMISSION_RESOURCES: readonly PermissionResource[] = [
  ...
  // Cadastros base
  R("cost_centers", "Centros de Resultado", "Cadastros Base > Estrutura"),
  R("farms", "Empresas", "Cadastros Base > Estrutura", [...CRUD, "import_kml"]),
  ...
  R("batch_farm_transfer", "Lote/Empresa", "Operacional > Pecuária > Transferências", ["view", "create", "process"]),
  R("animal_farm_transfer", "Animal/Empresa", "Operacional > Pecuária > Transferências", ["view", "create"]),
